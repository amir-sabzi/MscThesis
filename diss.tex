...
\examiningcommittee{Aastha Mehta, Assistant Professor, Computer Science, \textsc{UBC}}{Primary Supervisor}
...
% \input{src/glossary}	% always input, since other macros may rely on it
